...
MATH_ZERO_SHOT_PROMPT = """Think step-by-step to solve the following problem. End your answer with 'Final Answer: The final answer is X. I hope it is correct.', where X is your final answer."""

GPQA_ZERO_SHOT_PROMPT = """Think step-by-step to solve the following problem. Only include the letter choice (A, B, C, or D) as your final response. End your answer with 'Final Answer: The final answer is X. I hope it is correct.', where X is your final answer.
Problem: {problem}
Options: {options}
Answer:"""

QWQ_PROMPT = """Problem: {problem}\nMark your solution with \\boxed\nAnswer:"""

QWQ_VERIFY_PROMPT = """Verify the correctness of the following solution step by step. At the end, write 'Verification: Is the answer correct (Yes/No)? X', where X is either Yes or No.
